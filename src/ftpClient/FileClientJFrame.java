...
public class FileClientJFrame extends javax.swing.JFrame {
    ...
    private FileDataClient dataClient;
    private String msg;
    ...
    private void initComponents() {
        ...
        addressTextField.setText("192.168.221.74");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        dataClient = new FileDataClient(ip,port);
        try {
            dataClient.fileGet(inputTextArea.getText());
        } catch (IOException ex) {
            Logger.getLogger(FileClientJFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
